        ...
        <section className="py-24">
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    <FeatureCard title="Keyboard Quick Actions" description="Powerful commands to help you create designs quickly" className="md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-start-auto group">
